...
<html>
	...
	$db = new MySQLDatabase("localhost", "GestionStock", "root", "");
		$r = $_GET["code"];
		$res = $db->delete("fournisseur", "code", $r);
		if($res){
	?>
	<h1 align="center">Fournisseur supprimer</h1>
	<form action="index.html">
	<table><tr><td><input type="submit" value="Valider"/></td></tr></table>
	</form>
	<?php 
	}
	else{
	?>
	<h1 align="center">Fournisseur non supprimer</h1>
	<form action="index.html">
	<table><tr align="center"><td><input type="submit" value="Valider"/></td></tr></table>
	</form>
	<form action="SupprimerFournisseur.html">
