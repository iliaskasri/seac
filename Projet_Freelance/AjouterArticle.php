...
<html>
	...
	<?php 
		...
		$row[] = $_GET["stock"];
		$row[] = $_GET["famille"];
		$res = $db->insert($row, "article");
		if($res){
	?>
	<h1 align="center">Article bien enregistrer</h1>
	...
	?>
	<h1 align="center">Article non enregistrer</h1>
	<form action="index.html">
	<table><tr align="center"><td><input type="submit" value="Valider"/></td></tr></table>
	</form>
	<form action="AjouterArticle.html">
	<table><tr><td align="center"><input type="submit" value="Reessayer"/></td></tr></table>
	</form>
	<?php 
	}
	?>
