...
<html>
	...
	$db = new MySQLDatabase("localhost", "GestionStock", "root", "");
		$res = $db->selectByKey("article", "code", $_GET["code"]);
		$result = new ResultSet($res);
		?>
		<h1 align="center">Voici l'article correspendant au code demander</h1>
		<?php 
	...
	?>
	<h1 align="center">Article introuvable!</h1>
	<form action="index.html">
	<table><tr><td align="center"><input type="submit" value="Valider"/></td></tr></table>
	</form>
	<form action="ChercherArticle.html">
